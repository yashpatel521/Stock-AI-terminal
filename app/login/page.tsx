    ...
    <div className="flex-1 flex items-center justify-center bg-[#0B0E14] px-4 py-12">
      <div className="w-full max-w-md bg-[#131722] border border-[#2A2E39] rounded-lg p-8 shadow-xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold text-white">Access Research Terminal</h2>
          <p className="text-xs text-[#848E9C] mt-1">Please sign in to view your watchlist</p>
        </div>
        ...
        <div className="mt-6 text-center border-t border-[#2A2E39] pt-4">
          <p className="text-xs text-[#848E9C]">
            New to the terminal?{' '}
            <Link href="/register" className="text-[#089981] hover:underline font-medium">
              Create an account
            </Link>
          </p>
        </div>
